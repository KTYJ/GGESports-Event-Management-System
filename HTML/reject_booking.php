...
foreach($stat as $key => $value);
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        if(mysqli_num_rows($result) != 0){
            ...
            $sql = "UPDATE booking SET bookStatus = 'rejected' WHERE booking_id = ?";
            $stm = $con->prepare($sql);
            ...
            if ($stm->affected_rows > 0) {
                printf('
                    ...
                    <h2>Event <strong>%s</strong> has been rejected.</h2>
                ...
                <div class="info">
                <img src="/Media/tick.jpg">
                <h2>Event <strong>%s</strong> already been rejected.</h2>
                <input type="button" value="OK" class="info_button" onclick="location=\'manage_booking.php\'"/></div>',
                $booking_id);
            }
        }else{
